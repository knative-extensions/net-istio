...
require (
	...
	knative.dev/pkg v0.0.0-20200619154325-caa444033bbf
	knative.dev/serving v0.15.1-0.20200619144725-7589296bd02f
	knative.dev/test-infra v0.0.0-20200619142425-2abfb34c6a89
)
