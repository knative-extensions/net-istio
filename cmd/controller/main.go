...
func main() {
	...
	sharedmain.MainWithContext(pkg.GetContextWithFilteringLabelSelector(signals.NewContext()), "net-istio-controller", ingress.NewController, serverlessservice.NewController)
}
